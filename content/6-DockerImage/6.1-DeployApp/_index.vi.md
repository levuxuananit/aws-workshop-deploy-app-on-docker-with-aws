...
Kiểm tra các **backend-container** và **frontend-container** được build từ **backend-image** và **front-image** có đang hoạt động ổn định trên máy chủ **EC2 Instance**.
...
Các khắc phục:
  ...
  - Sửa thành `node-20-alpine` (nâng lên phiên bản cao hơn để đảm bảo **API Web Crypto** chạy ổn định)
